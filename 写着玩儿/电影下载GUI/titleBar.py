...
class TitleBar(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        #按钮格式
        qss = "QPushButton{border: 0px; color:#6699CC; background:#FFFFFF}"
